...
public class PiazzaBuildingScreen implements Screen {
    Sprite sprite;
    private static float SPRITE_LOCATION_X = -500;
    private static final float SPRITE_LOCATION_Y = -440;
    ...
    Texture PiazzaBuildingBackground;

    Texture SpaceButton;
    public PiazzaBuildingScreen(eng1Game game){
        this.game = game;
        SpaceButton = new Texture("SpaceButton.png");
        PiazzaBuildingBackground = new Texture("UniBuilding.png");
    }
    @Override
    public void show() {
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.batch.draw(PiazzaBuildingBackground, eng1Game.ORIGIN_X, eng1Game.ORIGIN_Y, eng1Game.WIDTH, eng1Game.HEIGHT);
